...
class DBPostgreFunctionality:
    ...
    def get_super_admin_using_email(self, super_admin_email: str, is_get_one_element: bool = True):
    ...
    def get_super_admin_using_super_admin_id(self, super_admin_id: str, is_get_one_element: bool = True):

        query_result = SuperAdmin.query.filter_by(id=super_admin_id)

        return self.get_element(query_result, is_get_one_element)

    def get_org_using_super_admin_id(self, super_admin_id: str, is_get_one_element: bool = True):
        """get organization data using super admin id"""

        query_result = Organization.query.filter_by(super_admin_id=super_admin_id)

        return self.get_element(query_result, is_get_one_element)

    def get_admin_using_org_id(self, org_id: str, admin_id: str, is_get_one_element: bool = True):
    ...
    def get_org_using_super_admin_id(self, super_admin_id: str, org_id: str, is_get_one_element: bool = True):
    ...
    def get_admin_using_admin_email(self, admin_email: str, is_get_one_element: bool = True):
        
        query_result = Admin.query.filter_by(email=admin_email)

        return self.get_element(query_result, is_get_one_element)

    def get_queue_using_admin_id(self, admin_id: str, queue_id: str, is_get_one_element: bool = True):
    ...
    def get_queue_user_using_queue_user_id(self, list_queue: list, queue_user_id: str, is_get_one_element: bool = True):
    ...
    def get_queue_using_queue_id(self, queue_id: str, is_get_one_element: bool = True):

        query_result = Queue.query.filter_by(id=queue_id)

        return self.get_element(query_result, is_get_one_element)

    def get_user_using_user_id(self, user_id: str, is_get_one_element: bool = True):

        query_result = User.query.filter_by(id=user_id)

        return self.get_element(query_result, is_get_one_element)

    def get_user_using_user_email(self, user_email: str, is_get_one_element: bool = True):

        query_result = User.query.filter_by(id=user_email)

        return self.get_element(query_result, is_get_one_element)

    def get_queue_user_using_queue_id_and_user_id(self, queue_id: str, user_id: str, is_get_one_element: bool = True):

        query_result = QueueUser.query.filter_by(queue_id=queue_id,user_id=user_id)

        return self.get_element(query_result, is_get_one_element)
    
    def get_queue_user_using_user_id(self, user_id: str, is_get_one_element: bool = True):

        query_result = QueueUser.query.filter_by(user_id=user_id)

        return self.get_element(query_result, is_get_one_element)

    def get_queue_user_using_list_queue_and_queue_user_id(self, list_queue: list, queue_user_id: str, is_get_one_element: bool = True):

        query_result = QueueUser.query.filter(QueueUser.queue_id.in_([queue.id for queue in list_queue]),QueueUser.id==queue_user_id)

        return self.get_element(query_result, is_get_one_element)

    def get_queue_using_list_queue_user(self, list_queue_user: list, is_get_one_element: bool = True):
