...
@swag_from("../docs/organization/get_organization.yaml", endpoint="organization.without_id", methods=["GET"])
@swag_from("../docs/organization/get_organization_by_id.yaml", endpoint="organization.with_id", methods=["GET"])
@swag_from("../docs/organization/post_organization.yaml", endpoint="organization.without_id", methods=["POST"])
...
@auth_super_admin.login_required
@swag_from("../docs/organization/delete_organization_by_id.yaml")
...
@auth_super_admin.login_required
@swag_from("../docs/organization/edit_organization_by_id.yaml")
